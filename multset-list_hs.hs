...
{-
 ...
 -}
inserir elem [] = [(elem, 1)]
inserir elem (a:as) | fst a == elem = (elem, ((snd a) + 1)) : as
                   | otherwise = a : inserir elem as
...
-}
remove elem [] = []
remove elem (a:as) | fst a == elem && snd a > 1 = (elem, ((snd a) - 1)) : as
                   | fst a == elem && snd a == 1 = as
                   | otherwise = a : remove elem as
